            ...
            <div className="bg-[#69235B]">
                ...
                <div className="flex justify-center items-center ">
                    <div className="md:mt-16 mt-12 ">
                        <div className="px-5">
                            <h3 className="md:text-6xl  text-3xl font-semibold text-white">
                                Discover the <br />timeless wisdom of <br /><span className="text-[#FFC746]">the Vedas.</span>
                            </h3>
                            <p className="text-white md:text-2xl text-xl font-light mt-3">Sign up and <span className="text-[#FBBC04]">journey through ancient <br /> knowledge with Arya 🌟</span></p>
                        </div>

                        <div className="flex gap-5 mt-9 justify-center">
                        ...
                        <div className="flex items-center gap-4 text-white my-5  font-thin md:text-xl ">
                            <hr className="w-[50%]" />
                            OR
                            <hr className="w-[50%]" />
                        </div>
                        ...
                        <p className="text-2xl mt-6 font-normal text-center text-white md:mb-14 mb-10">Existing account? <span className="text-[#FBBC04]"><Link to='/login/login'>
                        Log in</Link></span></p>
                    </div>
                </div>
